...
public class RegulationStrategyTest extends FaultBaseTest {
    ...
    public void testIsDegradeEffective() {
        ...
        InvocationStatDimension invocationA = new InvocationStatDimension(ProviderInfo.valueOf("ip"), consumerConfig);
    ...
    public void testIsReachMaxDegradeIpCount() {
        ...
        InvocationStatDimension invocation1 = new InvocationStatDimension(ProviderInfo.valueOf("ip1"), consumerConfig);
        ...
        InvocationStatDimension invocation2 = new InvocationStatDimension(ProviderInfo.valueOf("ip2"), consumerConfig);
        ...
        /**同一应用，同一服务，不同ip数已达最大*/
        InvocationStatDimension invocation3 = new InvocationStatDimension(ProviderInfo.valueOf("ip3"), consumerConfig);
        ...
        /**同一应用，不同服务，还可以增加*/
        InvocationStatDimension invocation4 = new InvocationStatDimension(ProviderInfo.valueOf("ip1"), consumerConfig);
        ...
        InvocationStatDimension invocation6 = new InvocationStatDimension(ProviderInfo.valueOf("ip1"), consumerConfig);
    ...
    public void testIsExistDegradeList() {
        ...
        /**加入到降级列表中*/
        InvocationStatDimension invocation2 = new InvocationStatDimension(ProviderInfo.valueOf("ip1"), consumerConfig);
        MeasureResultDetail measureResultDetail2 = new MeasureResultDetail(invocation2, MeasureState.ABNORMAL);
        Assert.assertFalse(regulationStrategy.isReachMaxDegradeIpCount(measureResultDetail2));

        /**相同应用，相同服务，相同ip，存在于降级列表中*/
        InvocationStatDimension invocation3 = new InvocationStatDimension(ProviderInfo.valueOf("ip1"), consumerConfig);
        MeasureResultDetail measureResultDetail3 = new MeasureResultDetail(invocation3, MeasureState.ABNORMAL);
        Assert.assertTrue(regulationStrategy.isExistInTheDegradeList(measureResultDetail3));

        /**相同应用，相同服务，不同ip，不存在于降级列表中*/
        InvocationStatDimension invocation4 = new InvocationStatDimension(ProviderInfo.valueOf("ip2"), consumerConfig);
        MeasureResultDetail measureResultDetail4 = new MeasureResultDetail(invocation4, MeasureState.ABNORMAL);
        Assert.assertFalse(regulationStrategy.isExistInTheDegradeList(measureResultDetail4));

        /**相同应用，不同服务，相同ip，存在于降级列表中*/
        InvocationStatDimension invocation5 = new InvocationStatDimension(ProviderInfo.valueOf("ip1"), consumerConfig2);
    ...
    public void testRecoverIpCount() {
        ...
        /**未达上限*/
        InvocationStatDimension invocation5 = new InvocationStatDimension(ProviderInfo.valueOf("ip3"), consumerConfig);
        MeasureResultDetail measureResultDetail5 = new MeasureResultDetail(invocation5, MeasureState.ABNORMAL);
