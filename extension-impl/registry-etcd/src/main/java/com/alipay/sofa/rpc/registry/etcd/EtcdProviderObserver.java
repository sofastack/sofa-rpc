...
public class EtcdProviderObserver {

    private final static Logger                                       LOGGER              = LoggerFactory
                                                                                              .getLogger(EtcdProviderObserver.class);
     ...
     */
    protected void updateProviders(ConsumerConfig config, List<ServiceInstance> instances) {
        ...
        if (CommonUtils.isNotEmpty(providerInfoListeners)) {
            List<ProviderInfo> providerInfos = EtcdRegistryHelper.convertInstancesToProviders(instances);
