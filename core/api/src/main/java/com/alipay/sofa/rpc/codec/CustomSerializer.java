...
public interface CustomSerializer<T> {
     ...
     */
    public AbstractByteBuf encodeObject(T object, Map<String, String> context) throws SofaRpcException;
     ...
     * @throws SofaRpcException 序列化异常
     */
    public void decodeObjectByTemplate(AbstractByteBuf data, Map<String, String> context, T template)
