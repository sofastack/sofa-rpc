 ...
 */
public class DynamicConfig extends AbstractIdConfig implements Serializable {
    /**
     ...
     * @return the protocol
     */
    public DynamicConfig setProtocol(String protocol) {
     ...
     * @return the address
     */
    public DynamicConfig setAddress(String address) {
     ...
     * @return the index
     */
    public DynamicConfig setIndex(String index) {
        this.index = index;
        return this;
    }
     ...
     * @return the register
     */
    public DynamicConfig setRegister(boolean register) {
     ...
     */
    public DynamicConfig setSubscribe(boolean subscribe) {
     ...
     * @return the timeout
     */
    public DynamicConfig setTimeout(int timeout) {
     ...
     * @return the connect timeout
     */
    public DynamicConfig setConnectTimeout(int connectTimeout) {
     ...
     * @return the file
     */
    public DynamicConfig setFile(String file) {
        this.file = file;
        return this;
    }
     ...
     * @return the batch
     */
    public DynamicConfig setBatch(boolean batch) {
        this.batch = batch;
        return this;
    }
     ...
     * @return the batch check
     */
    public DynamicConfig setBatchSize(int batchSize) {
     ...
     * @return the heartbeatPeriod
     */
    public DynamicConfig setHeartbeatPeriod(int heartbeatPeriod) {
     ...
     * @return the reconnectPeriod
     */
    public DynamicConfig setReconnectPeriod(int reconnectPeriod) {
     ...
     */
    public DynamicConfig setParameters(Map<String, String> parameters) {
     ...
     * @return the RegistryConfig
     */
    public DynamicConfig setParameter(String key, String value) {
        if (parameters == null) {
