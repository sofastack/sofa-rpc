...
/**
 * @author zhaowang
 * @version : FixedThreadPoolSupplier.java, v 0.1 2022年08月03日 2:45 PM zhaowang
 */
@Extension("fixed")
public class FixedThreadPoolSupplier implements ThreadPoolSupplier {
    @Override
    public ThreadPoolExecutor newThreadPool(int minPoolSize, int maxPoolSize, int queueSize, int aliveTime) {
