 ...
 */
public class FixedThreadPoolSupplierTest {
    ...
    public void newThreadPool() {
        ...
        FixedThreadPoolSupplier supplier = new FixedThreadPoolSupplier();
        ...
        assertEquals(ThreadPoolExecutor.class, threadPoolExecutor.getClass());
    }
}