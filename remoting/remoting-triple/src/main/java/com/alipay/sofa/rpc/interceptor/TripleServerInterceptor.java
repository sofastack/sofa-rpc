...
public abstract class TripleServerInterceptor implements ServerInterceptor {

    private ServerServiceDefinition serverServiceDefinition;

    public TripleServerInterceptor(ServerServiceDefinition serverServiceDefinition) {
