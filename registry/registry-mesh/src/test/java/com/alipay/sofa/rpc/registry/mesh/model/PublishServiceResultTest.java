...
/**
 * Unit tests for PublishServiceResult
 *
 * @author SOFA-RPC Team
 */
public class PublishServiceResultTest {

    @Test
    public void testGettersAndSetters() {
        PublishServiceResult result = new PublishServiceResult();
    ...
    public void testToString() {
        ...
        Assert.assertTrue(str.contains("PublishServiceResult"));
