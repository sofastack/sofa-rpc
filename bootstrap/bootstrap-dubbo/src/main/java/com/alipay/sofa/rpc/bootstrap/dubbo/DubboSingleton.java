...
public class DubboSingleton {
     ...
     */
    final static ConcurrentMap<RegistryConfig, org.apache.dubbo.config.RegistryConfig> REGISTRY_MAP = new ConcurrentHashMap<RegistryConfig, org.apache.dubbo.config.RegistryConfig>();
