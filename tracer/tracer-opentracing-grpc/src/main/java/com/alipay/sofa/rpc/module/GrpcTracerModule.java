...
import com.alipay.sofa.rpc.server.grpc.ServerReqHeaderInterceptor;
import com.alipay.sofa.rpc.server.grpc.ServerResHeaderInterceptor;
import com.alipay.sofa.rpc.transport.grpc.ClientHeaderClientInterceptor;
...
public class GrpcTracerModule implements Module {
    ...
    public void uninstall() {
        GrpcInterceptorManager.removeCustomConsumers();
        GrpcInterceptorManager.removeCustomProviders();
    }
}
