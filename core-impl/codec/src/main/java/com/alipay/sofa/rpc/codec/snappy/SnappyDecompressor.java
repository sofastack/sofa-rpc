...
import static com.alipay.sofa.rpc.codec.snappy.SnappyInternalUtils.copyLong;
import static com.alipay.sofa.rpc.codec.snappy.SnappyInternalUtils.loadByte;
import static com.alipay.sofa.rpc.codec.snappy.SnappyInternalUtils.lookupShort;
...
final class SnappyDecompressor {
    ...
    public static int uncompress(byte[] compressed, int compressedOffset, int compressedSize, byte[] uncompressed,
        ...
        SnappyInternalUtils.checkArgument(expectedLength <= uncompressed.length - uncompressedOffset,
                "Uncompressed length %s must be less than %s",
