...
public abstract class AbstractCluster extends Cluster {
    ...
    private int resolveTimeout(SofaRequest request, ConsumerConfig consumerConfig, ProviderInfo providerInfo) {
        ...
        if (StringUtils.isNotBlank(dynamicAlias)) {
            String dynamicTimeout = DynamicConfigManagerFactory.getDynamicManager(consumerConfig.getAppName(),
                dynamicAlias)
                .getConsumerMethodProperty(request.getInterfaceName(), request.getMethodName(), "timeout");
