...
public class SingleGroupAddressHolderTest {
    ...
    public void getProviders() throws Exception {
        ...
        addressHolder.registryGroup.add(ProviderInfo.valueOf("127.0.0.1:12200"));
        addressHolder.registryGroup.add(ProviderInfo.valueOf("127.0.0.1:12201"));
        ...
        addressHolder.directUrlGroup.add(ProviderInfo.valueOf("127.0.0.1:12200"));
