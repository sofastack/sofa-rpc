...
public class GrpcServerApplication {
    ...
    static final Logger LOGGER = LoggerFactory.getLogger(GrpcServerApplication.class);
    ...
    public static void main(String[] args) {
        ...
        ProviderConfig<GreeterImpl> providerConfig = new ProviderConfig<GreeterImpl>()
            ...
            .setBootstrap("grpc")
            .setInterfaceId(GreeterImpl.class.getName())
        ...
        synchronized (GrpcServerApplication.class) {
            try {
                while (true) {
                    GrpcServerApplication.class.wait();
                }
