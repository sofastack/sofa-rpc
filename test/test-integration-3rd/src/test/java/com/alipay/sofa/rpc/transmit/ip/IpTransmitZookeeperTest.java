 ...
 */
public class IpTransmitZookeeperTest extends ActivelyDestroyTest {
    ...
    public void test() throws InterruptedException {
        ...
        ipTransmitLauncher.setRegistry(transmitRegistry);
        ipTransmitLauncher.getRegistry().register(appName, ipTransmitLauncher.generateDataId(appName, "QQQ"));
        /*
        ...
        */
        ...
        // 3秒内全部转出去  B1 转到 B0
        String rule = "weightStarting:1,during:2,weightStarted:0,address:127.0.0.1,uniqueId:core_unique";
